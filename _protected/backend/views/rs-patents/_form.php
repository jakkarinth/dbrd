...
/* @var $model backend\models\RsPatents */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="rs-patents-form">

    <?php $form = ActiveForm::begin(); ?>

    <?= $form->field($model, 'a_pname')->textInput(['maxlength' => true]) ?>
    ...
    <?= $form->field($model, 'ref_pi')->textInput(['maxlength' => true]) ?>
