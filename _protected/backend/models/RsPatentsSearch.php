...
/**
 * RsPatentsSearch represents the model behind the search form about `backend\models\RsPatents`.
 */
class RsPatentsSearch extends RsPatents
{
    /**
     * @inheritdoc
     */
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'a_pname', $this->a_pname])
            ...
            ->andFilterWhere(['like', 'ref_pi', $this->ref_pi])
