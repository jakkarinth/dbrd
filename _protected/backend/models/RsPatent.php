...
/**
 * This is the model class for table "rs_patent".
 *
 * @property integer $id
 * @property string $a_aname
 ...
 * @property string $ref_ai
 * @property string $withs
 *
 * @property RsInfo $r
 * @property RsResearch $rs
 */
class RsPatent extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
